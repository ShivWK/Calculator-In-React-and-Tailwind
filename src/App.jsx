...
export default function () {
  ...
  return (
    ...
    <div className='main w-full h-screen' style={{backgroundColor : bgColor}}>
      ...
      <div className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[53%] px-2 py-2 md:w-[30%] w-11/12 h-5/6 rounded-lg">
        <CalHeader backgroundclr={bgcolorhandler}/>
        <CalDisplay dispColor={dispColor}/>
        <Keybord/>
      </div>
      <h3 className='text-gray-400 mx-auto absolute italic top-[95%] left-[50%] -translate-x-[50%]'>By Shivendra</h3>
    </div>
